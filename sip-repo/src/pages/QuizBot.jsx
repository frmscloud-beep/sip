  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      <div className="text-center mb-8">
        ...
        <h1 className="text-4xl font-bold font-montserrat text-oil mb-2">AI Drink Recommender</h1>
        <p className="text-judgeGray">Let AI help you discover your perfect drink</p>
      </div>
        ...
        <div className="space-y-4">
                        ...
                        <div className="mt-3 space-y-2">
                          {message.recommendations.map((rec, idx) => (
                            ...
                            >
                              ...
                              <span className="font-medium text-oil">{rec}</span>
                            </div>
                          ))}
                        </div>
                      )}
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-paleOyster rounded-2xl px-4 py-3">
      ...
      {step < questions.length && !loading && recommendations.length === 0 && (
        <div className="bg-white rounded-2xl shadow-lg p-6">
          <p className="text-oil font-medium mb-4">
